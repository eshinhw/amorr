...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1 Feedback: Some commit messages like "Updated code," "documented some stuff" are vague 
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 16 / 20 Feedback: 4 user cases completed fully (EB-39 - EB-6 refer to discord convo)
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
    ...
    Your Mark: 8 Feedback: Thank you for admitting that the Google API is buggy!
  ...
  - 0 marks = documentation has not been created
	...
	Your Mark: 1 Feedback: ReadMe needs to be updated
